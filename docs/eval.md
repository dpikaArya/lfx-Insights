...
numbered context list — is generated by `lfx_insights.eval.answer.answer_question`.
...
# export LFX_INSIGHTS_LLM__MODEL=gpt-4o          # or claude-opus-4-8, etc.
...
lfx-insights eval scholarqa --dataset ExpertQA/data/r2_compiled_anon.jsonl \
...
lfx-insights eval scholarqa --dataset litsearch_combined.jsonl \
