...
- :class:`LexicalEntailer` â€” fast, deterministic token-overlap heuristic.
- :class:`GroundingEntailer` â€” reuses indicium's verbatim grounding gate
  (verbatim/near-verbatim support only; no paraphrase).
- :class:`LLMEntailer` â€” a single structured NLI-style LLM call (highest
...
class GroundingEntailer:
    ...
    premise. Strict by design â€” paraphrase does not count as support.
    """
