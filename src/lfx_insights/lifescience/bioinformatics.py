...
* Detection is **assay-aware** â€” specific assay terms win over generic
  ...
  proteomics/metabolomics/metagenomics) also matched in the same paper â€” so a
...
# reports transcriptomics, never genomics â€” independent of declaration order.
...
def _classify_paper(paper: Paper, rules: list[_OmicsRule]) -> dict[str, list[str]]:
    ...
    paper classifies as transcriptomics only, never genomics â€” generic
