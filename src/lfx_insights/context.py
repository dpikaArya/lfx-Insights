...
if TYPE_CHECKING:
    ...
    from lfx_insights.models import Corpus, GeneratedSection, Theme
...
def build_context(
    ...
    *,
    ...
    """
    from lfx_insights.io.store import OutputStore
    from lfx_insights.llm.client import MockLLM, build_client, validate_ollama
    from lfx_insights.logging import configure
    from lfx_insights.sources.base import build_backend
    from lfx_insights.themes.discover import SimpleEmbedder, default_embedder
