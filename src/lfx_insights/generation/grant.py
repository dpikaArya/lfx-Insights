...
Any section whose body trips :func:`has_output_leak` is rejected â€” these are
...
from lfx_insights.models import GeneratedSection, Provenance
...
def _build_prompt(section: str, corpus: Corpus) -> str:
    ...
    return (
        ...
        "do not paraphrase the quote â€” copy it verbatim or it will be dropped."
    )
