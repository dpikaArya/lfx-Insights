...
relevant corpus papers and reports recall@k. This module adds that intrinsic measure —
recall@k and nDCG@k under binary relevance — so a retrieval condition (especially
Perspicacité) can be scored directly, not just through the answer it enables.
...
from consilium.eval.models import RetrievalScore
