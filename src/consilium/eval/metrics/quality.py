...
- **organization & coherence** — is the answer well structured and internally consistent;
- **coverage & amount of information** — does it address the question thoroughly;
- **relevance & focus** — does it stay on-topic without padding.
...
directionally comparable — not numerically interchangeable — with the paper.
...
from consilium.eval.models import QualityScore
