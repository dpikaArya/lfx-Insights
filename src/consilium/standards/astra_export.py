"""Export Consilium insights to an ASTRA ``InsightCollection``-shaped dict.
...
if TYPE_CHECKING:
    from consilium.models import Insight
...
def insights_to_collection(
    ...
    """Build an ASTRA InsightCollection-shaped dict from Consilium insights."""
    return {
