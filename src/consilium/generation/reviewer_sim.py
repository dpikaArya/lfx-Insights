...
missing citations, methodological gaps) — not a template that always fires. The
...
from consilium.generation.common import format_apa, has_output_leak
from consilium.models import ReviewComment

if TYPE_CHECKING:
    from consilium.llm.client import LLMClient
    from consilium.models import Corpus, GeneratedSection
