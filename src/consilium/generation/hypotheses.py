...
form, grounded in a Perspicacité corpus. The direction/qualifier is supplied by the
...
from consilium.generation.common import grounded_evidence, has_output_leak
from consilium.models import EvidenceRef, Hypothesis, Provenance
