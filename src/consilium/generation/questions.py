...
Generates open research questions from a Perspicacité-built corpus. The LLM is
...
LLM-provided components — never an RNG or hash. Output with formatting leaks
...
from consilium.generation.common import ground_cited, has_output_leak
from consilium.models import EvidenceRef, ResearchQuestion, ScoreComponent
