...
comparability across studies has not been extracted — readiness is approximated
...
from consilium.corpus_features import keyword_homogeneity, max_year, theme_papers
from consilium.models import EvidenceRef, Insight, ScoreComponent
from consilium.scoring.common import clamp01, make_score, sample_uncertainty
