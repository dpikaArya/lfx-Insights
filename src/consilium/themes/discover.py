...
from consilium.models import Paper, Theme
...
class LiteLLMEmbedder:
    """Hosted-API embedder via LiteLLM — the high-quality generalist tier.
    ...
    Routes OpenAI/Cohere/Voyage/etc. through LiteLLM, like Perspicacité's embedding layer.
    """
